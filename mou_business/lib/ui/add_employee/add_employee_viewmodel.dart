...
class AddEmployeeViewModel extends BaseViewModel {
  ...
  bool validate() {
    if (contact == null && employee == null) {
      showSnackBar(allTranslations.text(AppLanguages.validateSelectEmployee));
      return false;
    } else if ((employeeRoleController.value.text.trim().isEmpty)) {
